  ...
  return (
    <div className='w-full mt-10'>
         <div className='max-w-screen-xl mx-auto text-center relative'>
            <h1 className='text-[30vw] font-semibold leading-none tracking-tight select-none'>Work</h1>
            <div className='w-full h-full absolute top-0'>
              {images.map((elem,index)=>{
                return elem.isActive &&  <img key={index} className='w-60 absolute -translate-x-[50%] -translate-y-[50%]  ' src={elem.url} style={{top: elem.top,left:elem.left}} alt=""/>
              })}
            </div>
         </div>
    </div>
